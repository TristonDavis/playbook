  ...
  return (
    <div className="min-h-screen bg-pb-bg flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="flex flex-col items-center gap-3 mb-8">
        ...
        <p className="text-[13px] text-pb-muted">Create your free account</p>
      </div>

      {/* Free tier callout */}
      <div className="flex items-center gap-2 bg-blue-500/10 border border-blue-400/20 rounded-full px-4 py-1.5 mb-6">
        <span className="w-1.5 h-1.5 rounded-full bg-pb-blue-lt" />
        <span className="text-[11px] font-medium text-pb-blue-lt tracking-wide">Free forever · No credit card required</span>
      </div>
